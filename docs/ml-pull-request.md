...
Opening a pull request will trigger a[workflow](../.github/workflows/Luv-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-7135541228906330.10.azuredatabricks.net/explore/data/models/staging/Luv/Luv-model)
* [Prod model in UC](https://adb-7135541228906330.10.azuredatabricks.net/explore/data/models/prod/Luv/Luv-model)
. 
