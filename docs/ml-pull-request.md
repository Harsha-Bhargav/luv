...
Opening a pull request will trigger a[workflow](../.github/workflows/luv2-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-7135541228906330.10.azuredatabricks.net/ml/models/staging-luv2-model)
* [Prod workspace registered model](https://adb-7135541228906330.10.azuredatabricks.net/ml/models/prod-luv2-model). 
