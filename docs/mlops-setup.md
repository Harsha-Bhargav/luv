...
git add README.md docs .gitignore Luv/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[Luv/databricks.yml](../Luv/databricks.yml) file.
...
Follow the instructions in [Luv/resources/README.md](../Luv/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../Luv/resources/README.md)  to propose, test, and deploy
