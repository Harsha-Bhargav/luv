...
git add README.md docs .gitignore luv2/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-7135541228906330.10.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-7135541228906330.10.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[luv2/databricks.yml](../luv2/databricks.yml) file.
...
Follow the instructions in [luv2/resources/README.md](../luv2/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../luv2/resources/README.md)  to propose, test, and deploy
